...
categories: 
  ...
  - "security"
---
In my last post, I demonstrated how to add a user to Entra ID. However, manually adding users isn't typically best practice because it is time-consuming and results in access inconsistencies. These inconsistencies can lead to data breaches and security gaps. 

Therefore, it is best to create groups first then add users or employees to these groups. This minimizes security risks and reduces overhead. It also ensures that all users or employees within a group have consistent and appropriate permissions. 
